...
auto get_cfg(int argc, char* argv[])
{
   ...
   ("chat-admin-id", po::value<std::string>(&cfg.core.chat_admin_id))
   ...
   ("redis-key-removed-posts", po::value<std::string>(&cfg.core.redis.removed_posts_key)->default_value("removed_posts"))
